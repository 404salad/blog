...
Here are some of the second order benefits I've seen due to the rise of claude code (and other ai agents) -
...
- Context: Claude does not have the entire repo in its context at once, it fires a few grep queries and gets enough context to do simple tasks. I have started doing the same except I have much more than 1M context.
